export default function Footer() {
  return (
    <footer className="border-t border-white/10 py-8 bg-black text-center text-sm text-gray-400 transition-colors duration-500">
      <div className="container-bleed">
        ...
        <div className="mt-3">
          <a href="/terms" className="text-xs text-gray-500 hover:text-gray-300 transition">
            Terms & Privacy
          </a>
        </div>
      </div>
