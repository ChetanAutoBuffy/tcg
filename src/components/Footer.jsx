...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 py-12 bg-black/80 backdrop-blur-sm text-center text-sm text-gray-400">
      <div className="container-bleed">
        {/* Main Footer Content */}
        <div className="max-w-4xl mx-auto">
          {/* Logo/Brand */}
          <div className="mb-6">
            <span className="text-xl font-bold text-white">TCG Software</span>
          </div>
          ...
          <div className="flex justify-center gap-4 mb-8">
            <a
              ...
              className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-[#0077B5] hover:border-[#0077B5]/30 transition"
              aria-label="LinkedIn"
            >
