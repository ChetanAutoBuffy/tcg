...
export default function App() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 bg-black/95 backdrop-blur-sm border-b border-white/10">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-3">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/" className="text-sm font-semibold text-white/80 hover:text-white transition">
              Home
            </Link>
            <Link to="/about" className="text-sm font-semibold text-white/80 hover:text-white transition">
              About
            </Link>
            <Link to="/software" className="text-sm font-semibold text-white/80 hover:text-white transition">
              Software
            </Link>
            <Link to="/api" className="text-sm font-semibold text-white/80 hover:text-white transition">
              API
            </Link>
            <Link to="/investor-relations" className="text-sm font-semibold text-white/80 hover:text-white transition">
              Investors
            </Link>
            <Link to="/press" className="text-sm font-semibold text-white/80 hover:text-white transition">
              Press
            </Link>
            <button 
              onClick={() => setContactPopupOpen(true)}
              className="inline-flex items-center justify-center rounded-xl border border-white/20 px-5 py-2 text-sm font-semibold text-white hover:bg-white/10 transition"
            >
              Contact
            </button>
          </div>
          ...
          <button 
            type="button"
            className="md:hidden text-white p-2 rounded-lg bg-white/10 hover:bg-white/20 transition border border-white/20" 
      ...
      {/* Main Content - Mobile Responsive Wrapper */}
      <main className="relative z-10 flex-1 text-white">
        <Routes>
          <Route path="/" element={
            <>
              {/* Hero - Mobile/Desktop versions */}
              ...
              {/* Homepage: Just the essentials with CTAs to full pages */}
              <Legacy />
              <Technologies />
              <Brands />
              <PressReleases />
          ...
          <Route path="/software" element={<SoftwareArm />} />
